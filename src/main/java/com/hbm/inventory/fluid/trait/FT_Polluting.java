...
public class FT_Polluting extends FluidTrait {
    ...
    public void addInfo(List<String> info) {
        info.add(ChatFormatting.GOLD + "[Polluting]");
    }
    ...
    public void addInfoHidden(List<String> info) {
        ...
        if(!this.releaseMap.isEmpty()) {
            ...
            for(Map.Entry<PollutionHandler.PollutionType, Float> entry : releaseMap.entrySet()) info.add(ChatFormatting.GREEN + " - " + entry.getValue() + " " + entry.getKey() + " per mB");
        }

        if(!this.burnMap.isEmpty()) {
            info.add(ChatFormatting.RED + "When burned:");
            for(Map.Entry<PollutionHandler.PollutionType, Float> entry : burnMap.entrySet()) info.add(ChatFormatting.RED + " - " + entry.getValue() + " " + entry.getKey() + " per mB");
        }
    }
