...
public class ContainerMachinePlasmaHeater extends Container {
  ...
  public ContainerMachinePlasmaHeater(
      InventoryPlayer invPlayer, TileEntityMachinePlasmaHeater tile) {

    plasmaHeater = tile;

    this.addSlotToContainer(new SlotItemHandler(tile.inventory, 0, 8, 53));
