...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_epress, 1), new AStack[] { new OreDictStack(STEEL.plate(), 8), new OreDictStack(ANY_RUBBER.ingot(), 4), new ComparableStack(ModItems.pipes_steel, 1), new OreDictStack(W.bolt(), 4), new ComparableStack(ModItems.coil_copper, 2), new ComparableStack(ModItems.motor, 1), new ComparableStack(ModItems.circuit_copper, 1), new ComparableStack(ModItems.canister_generic, 1, Fluids.LUBRICANT.getID()), }, 160);
		makeRecipe(new ComparableStack(ModBlocks.machine_chemplant, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 8), new OreDictStack(CU.plate(), 6), new ComparableStack(ModItems.hull_small_steel, 2), new OreDictStack(W.bolt(), 4), new ComparableStack(ModItems.hull_big_steel, 1), new ComparableStack(ModItems.wire_fine, 16, Mats.MAT_MINGRADE.id), new ComparableStack(ModItems.wire_fine, 3, Mats.MAT_TUNGSTEN.id), new ComparableStack(ModItems.circuit_copper, 4), new ComparableStack(ModItems.circuit_red_copper, 2), new ComparableStack(ModItems.plate_polymer, 8), }, 200);
		makeRecipe(new ComparableStack(ModBlocks.machine_assemfac, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 48), new OreDictStack(ANY_RESISTANTALLOY.ingot(), 8), new OreDictStack(B.ingot(), 4), new OreDictStack(RUBBER.ingot(), 16), new OreDictStack(KEY_ANYPANE, 64), new ComparableStack(ModItems.motor, 18), new OreDictStack(W.bolt(), 16), new ComparableStack(ModItems.pipes_steel, 8), new ComparableStack(ModItems.circuit_aluminium, 16)}, 400);
