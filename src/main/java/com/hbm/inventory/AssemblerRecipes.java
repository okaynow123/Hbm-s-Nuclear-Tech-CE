...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.fuel_tank_small, 1), new AStack[] { new NbtComparableStack(ItemFluidCanister.getFullCanister(Fluids.KEROSENE, 6)), new OreDictStack(TI.plate(), 6), new OreDictStack(STEEL.plate(), 2), }, 100);
		makeRecipe(new ComparableStack(ModItems.fuel_tank_medium, 1), new AStack[] { new NbtComparableStack(ItemFluidCanister.getFullCanister(Fluids.KEROSENE, 8)), new OreDictStack(TI.plate(), 12), new OreDictStack(STEEL.plate(), 4), }, 150);
		makeRecipe(new ComparableStack(ModItems.fuel_tank_large, 1), new AStack[] { new NbtComparableStack(ItemFluidCanister.getFullCanister(Fluids.KEROSENE, 12)), new OreDictStack(TI.plate(), 24), new OreDictStack(STEEL.plate(), 8), }, 200);
