...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.missile_assembly, 1), new AStack[] { new ComparableStack(ModItems.hull_small_steel, 1), new ComparableStack(ModItems.hull_small_aluminium, 4), new OreDictStack(STEEL.ingot(), 2), new OreDictStack(TI.plate(), 6), new ComparableStack(ModItems.wire_aluminium, 6), new ComparableStack(ModItems.canister_generic, 3, Fluids.KEROSENE.getID()), new ComparableStack(ModItems.circuit_targeting_tier1, 1), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.sat_foeq, 1), new AStack[] { new OreDictStack(STEEL.plate(), 8), new OreDictStack(TI.plate(), 12), new ComparableStack(ModItems.plate_desh, 8), new ComparableStack(ModItems.hull_big_titanium, 3), new NbtComparableStack(ItemFluidTank.getFullBarrel(Fluids.WATER)), new ComparableStack(ModItems.photo_panel, 16), new ComparableStack(ModItems.thruster_nuclear, 1), new ComparableStack(ModItems.rod_quad_uranium_fuel, 2), new ComparableStack(ModItems.circuit_targeting_tier5, 6), new ComparableStack(ModItems.magnetron, 3), new ComparableStack(ModItems.battery_lithium_cell_6, 1), }, 1200);
		...
		makeRecipe(new ComparableStack(ModItems.tritium_deuterium_cake, 1), new AStack[] { new NbtComparableStack(ItemCell.getFullCell(Fluids.DEUTERIUM, 6)), new NbtComparableStack(ItemCell.getFullCell(Fluids.TRITIUM, 2)), new ComparableStack(ModItems.lithium, 4), }, 150);
		...
		makeRecipe(new ComparableStack(ModBlocks.watz_element_depricated, 1), new AStack[] { new OreDictStack(W.ingot(), 4), new OreDictStack(ALLOY.plate(), 4), new ComparableStack(ModItems.rod_empty, 2), new ComparableStack(ModItems.wire_magnetized_tungsten, 2), new ComparableStack(ModItems.wire_advanced_alloy, 4), }, 200);
		makeRecipe(new ComparableStack(ModBlocks.watz_control_depricated, 1), new AStack[] { new OreDictStack(W.ingot(), 4), new OreDictStack(ALLOY.ingot(), 4), new OreDictStack(PB.ingot(), 2), new ComparableStack(ModItems.wire_magnetized_tungsten, 4), new ComparableStack(ModItems.wire_advanced_alloy, 2), }, 250);
		...
		makeRecipe(new ComparableStack(ModBlocks.watz_end_depricated, 1), new AStack[] { new OreDictStack(W.ingot(), 2), new OreDictStack(PB.ingot(), 2), new OreDictStack(STEEL.ingot(), 3), }, 150);
		makeRecipe(new ComparableStack(ModBlocks.watz_hatch_depricated, 1), new AStack[] { new ComparableStack(ModBlocks.reinforced_brick, 1), new OreDictStack(TI.plate(), 6), }, 200);
		makeRecipe(new ComparableStack(ModBlocks.watz_conductor_depricated, 1), new AStack[] { new OreDictStack(W.ingot(), 2), new OreDictStack(PB.ingot(), 2), new OreDictStack(STEEL.ingot(), 2), new ComparableStack(ModItems.wire_red_copper, 6), new ComparableStack(ModItems.wire_magnetized_tungsten, 2), new ComparableStack(ModItems.fuse, 4), new OreDictStack(DESH.nugget(), 3), }, 250);
		//FIXME
	//	makeRecipe(new ComparableStack(ModBlocks.watz_core, 1), new AStack[] { new ComparableStack(ModBlocks.block_meteor, 1), new ComparableStack(ModItems.circuit_gold, 5), new ComparableStack(ModItems.circuit_schrabidium, 2), new ComparableStack(ModItems.wire_magnetized_tungsten, 12), new OreDictStack(KEY_CIRCUIT_BISMUTH, 4), }, 350);
		...
		makeRecipe(new ComparableStack(ModItems.grenade_plasma, 2), new AStack[] { new OreDictStack(STEEL.plate(), 3), new OreDictStack(ALLOY.plate(), 1), new ComparableStack(ModItems.coil_advanced_torus, 1), new NbtComparableStack(ItemCell.getFullCell(Fluids.DEUTERIUM)), new NbtComparableStack(ItemCell.getFullCell(Fluids.TRITIUM)), }, 300);
		...
		makeRecipe(new ComparableStack(ModItems.mike_deut, 1), new AStack[] { new OreDictStack(IRON.plate(), 12), new OreDictStack(STEEL.plate(), 16), new NbtComparableStack(ItemCell.getFullCell(Fluids.DEUTERIUM, 10)), }, 250);
