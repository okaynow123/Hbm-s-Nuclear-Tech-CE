...
public class GUIRadiolysis extends GuiInfoContainer {
    ...
    public void drawScreen(int mouseX, int mouseY, float f) {
        ...
        Set<ItemRTGPellet> pellets = ItemRTGPellet.pelletMap.keySet();
        ...
        for(ItemRTGPellet pellet : pellets) {
            pelletText[i++] = I18nUtil.resolveKey("desc.gui.rtg.pelletPower", I18nUtil.resolveKey(pellet.getTranslationKey() + ".name"), pellet.getHeat() * 10);
        }
