...
public abstract class EntityThrowableNT extends Entity implements IProjectile {
    ...
    {
        this.dataManager.register(STUCK_IN, (byte) 0);
    }
    ...
    public void shoot(double x, double y, double z, float velocity, float inaccuracy)
    {
        ...
        y = y / (double)f;
        z = z / (double)f;
        x = x + this.rand.nextGaussian() * headingForceMult() * (double)inaccuracy;
        y = y + this.rand.nextGaussian() * headingForceMult() * (double)inaccuracy;
        z = z + this.rand.nextGaussian() * headingForceMult() * (double)inaccuracy;
        x = x * (double)velocity;
        y = y * (double)velocity;
        z = z * (double)velocity;
        this.motionX = x;
    ...
    public void getStuck(int x, int y, int z, int side) {
        ...
        this.yTile = y;
        this.zTile = z;
        this.inTile = world.getBlockState(new BlockPos(x, y, z)).getBlock();
        this.inGround = true;
        this.motionX = 0;
        this.motionY = 0;
        this.motionZ = 0;
