...
public class MainRegistry {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        GameRegistry.registerTileEntity(TileEntityMachineAmmoPress.class, new ResourceLocation(RefStrings.MODID, "tileentity_machine_ammo_press"));
        GameRegistry.registerTileEntity(TileEntityHeatBoilerIndustrial.class, new ResourceLocation(RefStrings.MODID, "tileentity_heat_boiler_industrial"));
        ...
        GameRegistry.registerTileEntity(TileEntityMachineCombustionEngine.class, new ResourceLocation(RefStrings.MODID, "tileentity_machine_combustion_engine"));
        ...
        GameRegistry.registerTileEntity(TileEntityElectrolyser.class, new ResourceLocation(RefStrings.MODID, "tileentity_electrolyser"));
        ...
        GameRegistry.registerTileEntity(TileEntityMachinePyroOven.class, new ResourceLocation(RefStrings.MODID, "tileentity_pyrooven"));
