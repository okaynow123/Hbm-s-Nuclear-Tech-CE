...
public class XFactory9mm {
    ...
    public static void init() {
        ...
        ModItems.gun_lag = new ItemGunBaseNT(ItemGunBaseNT.WeaponQuality.A_SIDE, "gun_lag", new GunConfig()
                ...
                .rec(new Receiver(0)
                        .dmg(25F).delay(4).dry(10).spread(0.005F).reload(53).jam(44).sound(new SoundEvent(new ResourceLocation("hbm:weapon.fire.pistol")), 1.0F, 1.0F)
        ...
        ModItems.gun_uzi = new ItemGunBaseNT(ItemGunBaseNT.WeaponQuality.A_SIDE, "gun_uzi", new GunConfig()
                ...
                .rec(new Receiver(0)
                        .dmg(3F).delay(2).dry(25).auto(true).spread(0.005F).reload(55).jam(50).sound(new SoundEvent(new ResourceLocation("hbm:weapon.fire.uzi")), 1.0F, 1.0F)
                        .mag(new MagazineFullReload(0, 30).addConfigs(p9_sp, p9_fmj, p9_jhp, p9_ap))
                        .offset(1, -0.0625 * 2.5, -0.25D)
        ...
        ModItems.gun_uzi_akimbo = new ItemGunBaseNT(ItemGunBaseNT.WeaponQuality.B_SIDE, "gun_uzi_akimbo",
                new GunConfig().dura(3_000).draw(15).inspect(31).crosshair(RenderScreenOverlay.Crosshair.CIRCLE).smoke(LAMBDA_SMOKE)
                        .rec(new Receiver(0)
                                .dmg(3F).spreadHipfire(0F).delay(2).dry(25).auto(true).spread(0.005F).reload(55).jam(50).sound(new SoundEvent(new ResourceLocation("hbm:weapon.fire.uzi")), 1.0F, 1.0F)
                                .mag(new MagazineFullReload(0, 30).addConfigs(p9_sp, p9_fmj, p9_jhp, p9_ap))
