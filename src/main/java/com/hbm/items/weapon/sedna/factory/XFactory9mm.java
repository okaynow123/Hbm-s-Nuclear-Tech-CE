...
public class XFactory9mm {
    ...
    public static void init() {
        ...
        ModItems.gun_greasegun = new ItemGunBaseNT(ItemGunBaseNT.WeaponQuality.A_SIDE, "gun_greasegun", new GunConfig()
                ...
                .rec(new Receiver(0)
                        .dmg(3F).delay(4).dry(40).auto(true).spread(0.015F).reload(60).jam(55).sound(new SoundEvent(new ResourceLocation("hbm:weapon.fire.greaseGun")), 1.0F, 1.0F)
        ...
        /*ModItems.gun_lag = new ItemGunBaseNT(ItemGunBaseNT.WeaponQuality.A_SIDE, new GunConfig()
        ...
        ModItems.gun_uzi = new ItemGunBaseNT(ItemGunBaseNT.WeaponQuality.A_SIDE, new GunConfig()
        ...
        ModItems.gun_uzi_akimbo = new ItemGunBaseNT(ItemGunBaseNT.WeaponQuality.B_SIDE,
    ...
    public static BiConsumer<ItemStack, ItemGunBaseNT.LambdaContext> LAMBDA_RECOIL_GREASEGUN = (stack, ctx) -> {
        ItemGunBaseNT.setupRecoil(2, (float) (ctx.getPlayer().getRNG().nextGaussian() * 0.5));
    };

    public static BiConsumer<ItemStack, ItemGunBaseNT.LambdaContext> LAMBDA_RECOIL_LAG = (stack, ctx) -> {
        ItemGunBaseNT.setupRecoil(5, (float) (ctx.getPlayer().getRNG().nextGaussian() * 1.5));
    };

    public static BiConsumer<ItemStack, ItemGunBaseNT.LambdaContext> LAMBDA_RECOIL_UZI = (stack, ctx) -> {
    ...
    @SuppressWarnings("incomplete-switch") public static BiFunction<ItemStack, HbmAnimationsSedna.AnimType, BusAnimationSedna> LAMBDA_LAG_ANIMS = (stack, type) -> {
        switch(type) {
            case EQUIP: return new BusAnimationSedna()
