	...
	public void renderByItem(ItemStack item) {
		...
		case FIRST_PERSON_RIGHT_HAND:
			if(type == TransformType.FIRST_PERSON_LEFT_HAND) {
				if(item.getItem() == ModItems.gun_hk69) {
					GlStateManager.translate(2.0, 0, -0.4);
					...
					GlStateManager.translate(-0.1, 0.25, 0.5);
					GL11.glRotated(30, 0, 0, 1);
					GL11.glRotated(95, 0, 1, 0);
				} else if(item.getItem() == ModItems.gun_flamer) {
					GlStateManager.translate(0.3, -0.6, 0);
				...
				if(item.getItem() == ModItems.gun_hk69) {
					...
					if(this.entity != null && entity.isSneaking()){
						GlStateManager.translate(0.5, 0.2, 1.14);
						GL11.glRotated(5, 0, 1, 0);
					}
					GL11.glRotated(-90, 0, 1, 0);
					GL11.glRotated(-25, 1, 0, 0);
					...
					if(this.entity != null && this.entity.isSneaking()) {
						GlStateManager.translate(0, 0.20, 0.72);
						GL11.glRotated(10, 0, 1, 0);
					}
					...
					if(this.entity != null && this.entity.isSneaking()) {
						GlStateManager.translate(-0.2, 0.25, 0.53);
						GL11.glRotated(10, 0, 1, 0);
					}
					GL11.glRotated(260, 0, 1, 0);
					GL11.glRotated(-25, 1, 0, 0);
					...
					if(this.entity != null && this.entity.isSneaking()) {
						GlStateManager.translate(0, 0.15, 0.53);
					}
					...
					GlStateManager.translate(-0.5, -1, 0.3);
					if(this.entity != null && entity.isSneaking()){
						GlStateManager.translate(-0.8, 0.55, 0.7);
		...
		case THIRD_PERSON_RIGHT_HAND:
			if(item.getItem() == ModItems.gun_hk69) {
				GlStateManager.translate(0.0, -0.3, -0.5);
				GL11.glRotated(180, 0, 1, 0);
			} else if(item.getItem() == ModItems.gun_deagle) {
				...
				GlStateManager.translate(0, -0.15, -1.3);
				GL11.glRotated(180, 0, 1, 0);
		...
		case GUI:
			...
			if(item.getItem() == ModItems.gun_hk69) {
				...
				GlStateManager.translate(-0.2F, -1.2F, 0.0F);
				GlStateManager.rotate(-90F, 0.0F, 1.0F, 0.0F);
				GlStateManager.rotate(-40F, 1.0F, 0.0F, 0.0F);
			} else if(item.getItem() == ModItems.gun_flechette) {
				GL11.glScaled(0.07, 0.07, 0.07);
				GlStateManager.translate(-3.75F, -2F, 0F);
				// GlStateManager.rotate(-90F, 0.0F, 1.0F, 0.0F);
