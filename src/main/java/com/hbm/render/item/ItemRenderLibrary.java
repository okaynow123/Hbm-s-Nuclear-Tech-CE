    ...
    public static void init() {
        ...
        renderers.put(Item.getItemFromBlock(ModBlocks.turret_light), new ItemRenderBase() {
            ...
            public void renderCommon() {
                ...
                GL11.glRotated(-90, 0, 1, 0);
                GlStateManager.shadeModel(GL11.GL_SMOOTH);
                bindTexture(ResourceManager.turret_mg_tex);
                ResourceManager.turret_mg.renderAll();
                GlStateManager.shadeModel(GL11.GL_FLAT);
            }
        });
        ...
        renderers.put(Item.getItemFromBlock(ModBlocks.turret_rocket), new ItemRenderBase() {
            ...
            public void renderCommon() {
                ...
                GL11.glRotated(-90, 0, 1, 0);
                GlStateManager.shadeModel(GL11.GL_SMOOTH);
                bindTexture(ResourceManager.turret_rocket_launcher_tex);
                ResourceManager.turret_rocket_launcher.renderAll();
                GlStateManager.shadeModel(GL11.GL_FLAT);
            }
        });
        ...
        renderers.put(Item.getItemFromBlock(ModBlocks.turret_flamer), new ItemRenderBase() {
            ...
            public void renderCommon() {
                ...
                GL11.glRotated(-90, 0, 1, 0);
                GlStateManager.shadeModel(GL11.GL_SMOOTH);
                bindTexture(ResourceManager.turret_flamethower_tex);
                ResourceManager.turret_flamethower.renderAll();
                GlStateManager.shadeModel(GL11.GL_FLAT);
            }
        });
        ...
        renderers.put(Item.getItemFromBlock(ModBlocks.turret_tau), new ItemRenderBase() {
            ...
            public void renderCommon() {
                ...
                GL11.glRotated(-90, 0, 1, 0);
                GlStateManager.shadeModel(GL11.GL_SMOOTH);
                bindTexture(ResourceManager.turret_tau_tex);
                ResourceManager.turret_tau.renderAll();
                GlStateManager.shadeModel(GL11.GL_FLAT);
            }
        });
        ...
        renderers.put(Item.getItemFromBlock(ModBlocks.turret_heavy), new ItemRenderBase() {
            ...
            public void renderCommon() {
                ...
                GL11.glRotated(-90, 0, 1, 0);
                GlStateManager.shadeModel(GL11.GL_SMOOTH);
                bindTexture(ResourceManager.turret_cannon_tex);
                ResourceManager.turret_cannon.renderAll();
                GlStateManager.shadeModel(GL11.GL_FLAT);
            }
        });
