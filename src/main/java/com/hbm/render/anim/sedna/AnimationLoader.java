...
public class AnimationLoader {
    ...
    public static HashMap<String, BusAnimationSedna> load(ResourceLocation file) {
        HashMap<String, BusAnimationSedna> animations = new HashMap<String, BusAnimationSedna>();
