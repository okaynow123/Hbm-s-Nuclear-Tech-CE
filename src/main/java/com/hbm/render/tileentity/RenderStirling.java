...
public class RenderStirling extends TileEntitySpecialRenderer<TileEntityStirling> implements  ITileActorRenderer {

    @Override
    public void render(TileEntityStirling tile, double x, double y, double z, float interp, int destroyStage, float alpha) {
        GL11.glPushMatrix();
