...
@AutoRegister
public class RenderPADetector extends TileEntitySpecialRenderer<TileEntityPADetector> implements IItemRendererProvider {

    @Override
    public void render(@NotNull TileEntityPADetector tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
