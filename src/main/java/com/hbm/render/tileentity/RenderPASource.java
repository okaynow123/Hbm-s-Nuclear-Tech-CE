...
@AutoRegister
public class RenderPASource extends TileEntitySpecialRenderer<TileEntityPASource> implements IItemRendererProvider {

    @Override
    public void render(@NotNull TileEntityPASource tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
