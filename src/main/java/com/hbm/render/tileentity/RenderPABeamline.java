...
@AutoRegister
public class RenderPABeamline extends TileEntitySpecialRenderer<TileEntityPABeamline> implements IItemRendererProvider {

    @Override
    public void render(@NotNull TileEntityPABeamline tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
