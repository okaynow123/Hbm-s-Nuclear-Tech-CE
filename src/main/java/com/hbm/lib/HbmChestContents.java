...
import static com.hbm.items.machine.ItemBreedingRod.*;
import static com.hbm.items.machine.ItemBreedingRod.BreedingRodType.*;
...
//			new WeightedRandomChestContentFrom1710(ModItems.circuit_targeting_tier4, 0, 1, 1, 2),
	...
	private static WeightedRandomChestContentFrom1710[] nukeTrash = new WeightedRandomChestContentFrom1710[] {
			...
			new WeightedRandomChestContentFrom1710(ModItems.rod, U238.ordinal(), 1, 1, 3),
			new WeightedRandomChestContentFrom1710(ModItems.rod, NP237.ordinal(), 1, 1, 4),
			new WeightedRandomChestContentFrom1710(ModItems.rod, PU239.ordinal(), 1, 1, 3),
			new WeightedRandomChestContentFrom1710(ModItems.rod_dual, U238.ordinal(), 1, 1, 3),
			new WeightedRandomChestContentFrom1710(ModItems.rod_dual, PU239.ordinal(), 1, 1, 3),
			new WeightedRandomChestContentFrom1710(ModItems.rod_quad, U238.ordinal(), 1, 1, 3),
			new WeightedRandomChestContentFrom1710(ModItems.rod, PU239.ordinal(), 1, 1, 3),
	...
	private static WeightedRandomChestContentFrom1710[] nuclear = new WeightedRandomChestContentFrom1710[] {
			...
			new WeightedRandomChestContentFrom1710(ModItems.rod, U235.ordinal(), 1, 1, 3),
			new WeightedRandomChestContentFrom1710(ModItems.rod, PU239.ordinal(), 1, 1, 3),
			new WeightedRandomChestContentFrom1710(ModItems.rod_dual, U235.ordinal(), 1, 1, 3),
			new WeightedRandomChestContentFrom1710(ModItems.rod_dual, U235.ordinal(), 1, 1, 3),
			new WeightedRandomChestContentFrom1710(ModItems.rod_quad, U235.ordinal(), 1, 1, 3),
			new WeightedRandomChestContentFrom1710(ModItems.rod_quad, U235.ordinal(), 1, 1, 3),
			new WeightedRandomChestContentFrom1710(ModItems.rod, URANIUM.ordinal(), 1, 1, 4),
...
//			new WeightedRandomChestContentFrom1710(ModItems.rod_mox_fuel, 0, 1, 1, 4),
			new WeightedRandomChestContentFrom1710(ModItems.rod_dual, URANIUM.ordinal(), 1, 1, 3),
...
//			new WeightedRandomChestContentFrom1710(ModItems.rod_dual_mox_fuel, 0, 1, 1, 3),
			new WeightedRandomChestContentFrom1710(ModItems.rod_quad, URANIUM.ordinal(), 1, 1, 1),
//			new WeightedRandomChestContentFrom1710(ModItems.rod_quad_plutonium_fuel, 0, 1, 1, 1),
//			new WeightedRandomChestContentFrom1710(ModItems.rod_quad_mox_fuel, BreedingRodType., 1, 1, 1),
	...
	private static WeightedRandomChestContentFrom1710[] vertibird = new WeightedRandomChestContentFrom1710[] {
			...
			new WeightedRandomChestContentFrom1710(ModItems.rod, URANIUM.ordinal(), 1, 1, 2),
			new WeightedRandomChestContentFrom1710(ModItems.rod_dual, URANIUM.ordinal(), 1, 1, 2),
			new WeightedRandomChestContentFrom1710(ModItems.rod_quad, URANIUM.ordinal(), 1, 1, 2),
