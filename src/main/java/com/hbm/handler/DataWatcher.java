...
// do you fucking SERIOUSLY think I'd use DataManager when I can't implement anything related to (int, Object)? Nah go fuck yourself mojank
    ...
    private static void writeWatchableObjectToPacketBuffer(PacketBuffer p_151510_0_, DataWatcher.WatchableObject p_151510_1_) throws IOException
    {
        ...
        switch (p_151510_1_.getObjectType())
        {
            ...
            case 5:
                ...
                p_151510_0_.writeItemStack(itemstack);
                break;
            case 6:
                BlockPos chunkcoordinates = (BlockPos)p_151510_1_.getObject();
                p_151510_0_.writeInt(chunkcoordinates.getX());
                p_151510_0_.writeInt(chunkcoordinates.getY());
                p_151510_0_.writeInt(chunkcoordinates.getZ());
        }
    }
        ...
        for (byte b0 = p_151508_0_.readByte(); b0 != 127; b0 = p_151508_0_.readByte())
        {
            ...
            switch (i)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    watchableobject = new DataWatcher.WatchableObject(i, j, p_151508_0_.readString(32767));
                    break;
                case 5:
                    watchableobject = new DataWatcher.WatchableObject(i, j, p_151508_0_.readItemStack());
                    break;
                case 6:
