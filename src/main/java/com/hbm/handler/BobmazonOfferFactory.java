...
public class BobmazonOfferFactory {
	...
	public static void init() {
		...
		materials.add(new Offer(ItemFluidCanister.getFullCanister(Fluids.OIL), Requirement.OIL, 4 * inflation));
		materials.add(new Offer(ItemFluidCanister.getFullCanister(Fluids.DIESEL), Requirement.OIL, 16 * inflation));
		materials.add(new Offer(ItemFluidCanister.getFullCanister(Fluids.PETROIL), Requirement.OIL, 12 * inflation));
		materials.add(new Offer(ItemFluidCanister.getFullCanister(Fluids.KEROSENE), Requirement.OIL, 20 * inflation));
		materials.add(new Offer(ItemFluidCanister.getFullCanister(Fluids.NITAN), Requirement.OIL, 100 * inflation));
		materials.add(new Offer(ItemGasCanister.getFullCanister(Fluids.GAS), Requirement.OIL, 8 * inflation));
